...
The input and output files are located in the `data` folder. In its original form, the input file _all-nevada-2016.csv_ is obtained from a [separate repository](https://github.com/mguideng/Nevada-Public-Salaries) and has 12 columns. The output file _all-nevada-2016-with-gender.csv_ is the same, but has an additional column for employee gender. My little contribution is the R script that adds this feature through the use of this package.
...
Import the input file _all-nevada.2016.csv_ from this repository. This will take a few minutes.
